...
type WorktreeParams struct {
	...
	// shared cache. Linux Codex tasks use this to keep task Git writes isolated
	// from the shared repo cache and to remain compatible with explicit
	// workspace-write overrides (multica-ai/multica#2925).
